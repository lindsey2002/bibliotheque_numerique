...
--
-- Class Abonnement as table abonnement
--
CREATE TABLE "abonnement" (
    ...
    "dateProchainPaiement" timestamp without time zone,
...
--
-- Class AmbianceSonore as table ambiance_sonore
--
...
CREATE TABLE "avis" (
    ...
    "reponseAuteur" text,
    "dateReponseAuteur" timestamp without time zone,
    "lecteurId" bigint NOT NULL,
...
--
-- Class ChangementStatut as table changement_statut
--
...
--
-- Class Decision as table decision
--
...
--
-- Class Favoris as table favoris
--
...
--
-- Class Lecteur as table lecteur
--
...
--
-- Class Paiement as table paiement
--
...
--
-- Class SuperAdmin as table superadmin
--
...
--
-- Class TarifAbonnement as table tarif_abonnement
--
...
--
-- Class TauxCommission as table taux_commission
--
...
--
-- Class Versement as table versement
--
...
--
-- Foreign relations for "abonnement" table
--
...
--
-- Foreign relations for "avis" table
--
...
--
-- Foreign relations for "changement_statut" table
--
...
--
-- Foreign relations for "decision" table
--
...
--
-- Foreign relations for "favoris" table
--
...
--
-- Foreign relations for "lecture" table
--
...
--
-- Foreign relations for "livre" table
--
...
--
-- Foreign relations for "paiement" table
--
...
--
-- Foreign relations for "versement" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('bibliotheque_numerique', '20260808013647124', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260808013647124', "timestamp" = now();
